...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("MyHighScorePreferences", Context.MODE_PRIVATE);
        highscore1 = sharedPreferences.getInt("highscore1", 0);
    ...
    public void highScore() {
        if (score > highscore1) {
            highscore1 = score;
            sharedPreferences.edit().putInt("highscore1", highscore1).apply();
        }
