...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("MyHighScorePreferences3", Context.MODE_PRIVATE);
        highscore3 = sharedPreferences.getInt("highscore3", 0);
    ...
    public void highScore3(){
        if (score > highscore3) {
            highscore3 = score;
            sharedPreferences.edit().putInt("highscore3", highscore3).apply();
        }
    ...
    public void activitySecond(View view){
